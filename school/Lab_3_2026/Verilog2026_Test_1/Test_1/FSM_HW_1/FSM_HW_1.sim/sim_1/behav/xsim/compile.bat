...
REM
REM Generated by Vivado on Wed Apr 22 20:41:51 +0800 2026
...
echo "xvlog --incr --relax -prj FSM_HW_vlog.prj"
call xvlog  --incr --relax -prj FSM_HW_vlog.prj -log xvlog.log
