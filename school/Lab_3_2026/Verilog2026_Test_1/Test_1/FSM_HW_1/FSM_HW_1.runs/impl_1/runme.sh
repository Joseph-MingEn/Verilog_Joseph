...
HD_PWD='C:/Users/user/Documents/GitHub/Verilog_Joseph/school/Lab_3_2026/Verilog2026_Test_1/Test_1/FSM_HW_1/FSM_HW_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_HW.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_HW.tcl -notrace
