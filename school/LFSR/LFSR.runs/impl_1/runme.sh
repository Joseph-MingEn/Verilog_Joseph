...
HD_PWD='C:/Users/user/Documents/GitHub/Verilog_Joseph/school/LFSR/LFSR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_LFSR_COMPARE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TB_LFSR_COMPARE.tcl -notrace
