...
HD_PWD='C:/Users/user/Documents/GitHub/Verilog_Joseph/school/LFSR/LFSR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_LFSR_COMPARE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TB_LFSR_COMPARE.tcl
