...
REM
REM Generated by Vivado on Thu May 07 10:29:51 +0800 2026
...
echo "xvlog --incr --relax -prj TB_LFSR_COMPARE_vlog.prj"
call xvlog  --incr --relax -prj TB_LFSR_COMPARE_vlog.prj -log xvlog.log
