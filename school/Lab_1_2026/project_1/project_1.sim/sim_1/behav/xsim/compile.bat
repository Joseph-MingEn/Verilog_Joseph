...
REM
REM Generated by Vivado on Wed May 06 20:23:56 +0800 2026
...
echo "xvlog --incr --relax -prj TB_ID_Count_vlog.prj"
call xvlog  --incr --relax -prj TB_ID_Count_vlog.prj -log xvlog.log
