...
REM
REM Generated by Vivado on Fri Apr 24 14:52:59 +0800 2026
...
echo "xvlog --incr --relax -prj TB_FSM_HW4_vlog.prj"
call xvlog  --incr --relax -prj TB_FSM_HW4_vlog.prj -log xvlog.log
