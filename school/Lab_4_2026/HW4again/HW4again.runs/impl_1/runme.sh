...
HD_PWD='C:/Users/user/Documents/GitHub/Verilog_Joseph/school/Lab_4_2026/HW4again/HW4again.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_FSM_Delay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TB_FSM_Delay.tcl -notrace
