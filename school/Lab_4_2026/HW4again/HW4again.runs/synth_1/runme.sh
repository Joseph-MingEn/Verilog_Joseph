...
HD_PWD='C:/Users/user/Documents/GitHub/Verilog_Joseph/school/Lab_4_2026/HW4again/HW4again.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_FSM_Delay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TB_FSM_Delay.tcl
