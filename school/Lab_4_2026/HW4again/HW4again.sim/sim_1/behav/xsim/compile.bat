...
REM
REM Generated by Vivado on Fri May 22 13:14:53 +0800 2026
...
echo "xvlog --incr --relax -prj TB_FSM_Delay_vlog.prj"
call xvlog  --incr --relax -prj TB_FSM_Delay_vlog.prj -log xvlog.log
