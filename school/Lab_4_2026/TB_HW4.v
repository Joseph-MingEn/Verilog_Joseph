...
always @(posedge clk) begin
    $fwrite(sim_out, "rst=%b, In=%b, CurrentState= 3'b%b%b%b, NextState= 3'b%b%b%b, Out= 4'b%b%b%b%b\n", 
        rst, In, 
        TB_FSM_HW4.U_fsm.Org_State[2], TB_FSM_HW4.U_fsm.Org_State[1], TB_FSM_HW4.U_fsm.Org_State[0], 
        TB_FSM_HW4.U_fsm.New_State[2], TB_FSM_HW4.U_fsm.New_State[1], TB_FSM_HW4.U_fsm.New_State[0], 
