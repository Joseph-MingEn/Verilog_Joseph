...
REM
REM Generated by Vivado on Fri May 29 14:04:19 +0800 2026
...
echo "xvlog --incr --relax -prj TB_STUDENT_ROM_vlog.prj"
call xvlog  --incr --relax -prj TB_STUDENT_ROM_vlog.prj -log xvlog.log
