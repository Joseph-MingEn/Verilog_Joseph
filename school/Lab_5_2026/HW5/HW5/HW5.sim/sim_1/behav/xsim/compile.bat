...
REM
REM Generated by Vivado on Fri May 29 14:14:36 +0800 2026
...
echo "xvlog --incr --relax -prj TB_DIRECT_Y_vlog.prj"
call xvlog  --incr --relax -prj TB_DIRECT_Y_vlog.prj -log xvlog.log
