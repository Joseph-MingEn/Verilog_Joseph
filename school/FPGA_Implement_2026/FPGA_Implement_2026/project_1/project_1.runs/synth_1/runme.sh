...
HD_PWD='C:/Users/Administrator/Desktop/Classes/NTOU_20260201/VerilogAndFPGA/W5/FPGA_Implement_2026/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClkDiv26Bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClkDiv26Bits.tcl
