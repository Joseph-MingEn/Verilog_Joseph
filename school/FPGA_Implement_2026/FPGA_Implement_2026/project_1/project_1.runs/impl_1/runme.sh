...
HD_PWD='C:/Users/Administrator/Desktop/Classes/NTOU_20260201/VerilogAndFPGA/W5/FPGA_Implement_2026/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ClkDiv26Bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ClkDiv26Bits.tcl -notrace
