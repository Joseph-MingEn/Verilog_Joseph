...
REM
REM Generated by Vivado on Thu Apr 16 14:35:43 +0800 2026
...
echo "xvlog --incr --relax -prj TB_DoubleHalf_vlog.prj"
call xvlog  --incr --relax -prj TB_DoubleHalf_vlog.prj -log xvlog.log
