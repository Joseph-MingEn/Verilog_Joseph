...
HD_PWD='C:/Users/user/Documents/GitHub/Verilog_Joseph/school/w7/w7/w7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_PI4_pip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TB_PI4_pip.tcl
