...
REM
REM Generated by Vivado on Fri May 29 14:51:53 +0800 2026
...
echo "xvlog --incr --relax -prj TB_Lab6_1_Top_vlog.prj"
call xvlog  --incr --relax -prj TB_Lab6_1_Top_vlog.prj -log xvlog.log
