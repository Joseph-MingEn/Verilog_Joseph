...
REM
REM Generated by Vivado on Fri May 29 15:52:31 +0800 2026
...
echo "xvlog --incr --relax -prj TB_Lab6_4_vlog.prj"
call xvlog  --incr --relax -prj TB_Lab6_4_vlog.prj -log xvlog.log
